  ...
  theme: {
    extend: {
      colors: {
        ...
        primary: { DEFAULT: '#3d4a5c', container: '#5b6b7e' },
        'on-primary': '#fff8f3',
        secondary: { DEFAULT: '#a14000', container: '#ff7a32' },
        'on-secondary': '#ffffff',
        tertiary: { DEFAULT: '#3d4a5c', container: 'rgba(61,74,92,0.06)' },
        'on-surface': '#3d4a5c',
        'on-surface-variant': '#5b6b7e',
      ...
      boxShadow: {
        ambient: '0 12px 40px rgba(61,74,92,0.06)',
        'ambient-lg': '0 20px 60px rgba(61,74,92,0.08)',
        'ambient-sm': '0 4px 16px rgba(61,74,92,0.04)',
      },
      backdropBlur: {
        glass: '12px',
      },
